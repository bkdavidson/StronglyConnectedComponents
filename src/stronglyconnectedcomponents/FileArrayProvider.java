        ...
        try (BufferedReader bufferedReader = new BufferedReader(fileReader)) {
            ...
            while ((stringline = bufferedReader.readLine()) != null) { //While there is data to read
                ...
                for (int j = 0; j < stringline.length(); j++){ //read the line
                    if (amIN == false && Character.isWhitespace(stringline.charAt(j))){}  //if I am not in a number and there is whitespace do nothing
                        ...
                        exp++; //since this is the first the exponent is now going up
